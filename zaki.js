		...
		for (let yoi of anu) {
		    await sleep(1500)
                    let btn = [{
                      ...
                      fatihgans = fs.readFileSync('./media/Zaki.jpg')
                      let txt = `「 BROADCAST BOT 」\n\n${text}`
                      Zaki.send5ButImg(yoi, txt, `${global.pengguna} | © 2021`, fatihgans, btn)
		}
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
    ...
    + 'FN:Mochi\n'
    + 'ORG:𝙼𝙾𝙲𝙷𝙸;\n'
    + 'item1.TEL;type=CELL;type=VOICE;waid=6282327020033:+62 823-2702-0033\n' 
    + 'item1.X-ABLabel:Creator Hinata - MDt\n'
    + 'item2.EMAIL;type=INTERNET:mochiganz937@gmail.com\n'
    + 'item2.X-ABLabel:Email\n'
    + 'item3.URL:https://instagram.com/zaqi.art_\n'
    + 'item3.X-ABLabel:Instagram\n'
    + 'item4.ADR:;;Indonesia;;;;\n'
    + 'item4.X-ABLabel:Region\n'
    + 'END:VCARD'
Zaki.sendMessage(m.chat, { contacts: { displayName: '𝙼𝙾𝙲𝙷𝙸', contacts: [{ vcard }] } }, { quoted: m })
            }
            break            
                    case 'bug': case 'report': {
                    	if(!text) throw `Enter The Bug Example\n\n${command} Menu Error `
                    	Zaki.sendMessage(`6282327020033@s.whatsapp.net`, {text: `*Bug Report From:* wa.me/${m.sender.split("@")[0]}
Report Message: ${text}` })
...
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            hydratedFooterText: `𝙼𝙾𝙲𝙷𝙸 | © 2022`,
                            hydratedButtons: [{
                                urlButton: {
                                    displayText: 'YouTube',
                                    url: 'https://m.youtube.com/channel/UCJCDjY1KFjQFPVk-FT-h6IQ'
                                }
                            }, {
                            	urlButton: {
                                displayText: 'Group',
                                    url: 'https://chat.whatsapp.com/GHO8cqWM7fIJO4xMy3PzRD'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: 'Menu',
...
_*🇬🇧 : List Of Feautures In This Bot*_.
_*🇮🇩 : Daftar Fitur Di Bot Ini*_.
_*🇯🇵 : このボットの機能のリスト*_.
                        ...
                        hydratedTemplate: {
                            ...
                            hydratedButtons: [{
                                urlButton: {
                                    ...
                                    url: 'https://instagram.com/zaqi.art_'
                                }
                            }, {
                                callButton: {
                                    displayText: 'Owner Number',
                                    phoneNumber: '+62 823-2702-0033'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: 'Speed',
